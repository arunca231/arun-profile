            ...
            if (cal.querySelector("include-fragment")) {
                ...
                if (options.global_stats !== false) {
                    var parsed = parse($("svg", cal).outerHTML),
                        currentStreakInfo = parsed.current_streak ? formatoid(parsed.current_streak_range[0], DATE_FORMAT) + " – " + formatoid(parsed.current_streak_range[1], DATE_FORMAT) : parsed.last_contributed ? "Last contributed in " + formatoid(parsed.last_contributed, DATE_FORMAT) + "." : "Rock - Hard Place",
                        longestStreakInfo = parsed.longest_streak ? formatoid(parsed.longest_streak_range[0], DATE_FORMAT) + " – " + formatoid(parsed.longest_streak_range[1], DATE_FORMAT) : parsed.last_contributed ? "Last contributed in " + formatoid(parsed.last_contributed, DATE_FORMAT) + "." : "Rock - Hard Place",
                        firstCol = $("<div>", {
